	...
	<tbody>
		...
		?>
				<tr>
					...
					<td align="center" width="70"><?php echo $db['no_rek']; ?></td>
					<td><?php echo $db['nama_rek']; ?></td>
					<td align="right" width="70"><?php echo number_format($dr_ju); ?></td>
					<td align="right" width="70"><?php echo number_format($kr_ju); ?></td>
					<td align="right" width="70"><?php echo number_format($dr_ajp); ?></td>
					<td align="right" width="70"><?php echo number_format($kr_ajp); ?></td>
					<td align="right" width="70"><?php echo number_format($dr_nssp); ?></td>
					<td align="right" width="70"><?php echo number_format($kr_nssp); ?></td>
					<td align="right" width="70"><?php echo number_format($dr_lr); ?></td>
					<td align="right" width="70"><?php echo number_format($kr_lr); ?></td>
					<td align="right" width="70"><?php echo number_format($dr_n); ?></td>
					<td align="right" width="70"><?php echo number_format($kr_n); ?></td>
				</tr>
			<?php
