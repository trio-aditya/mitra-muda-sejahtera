...
<script type="text/javascript">
    function autofill() {
        ...
        $.ajax({
            url: "<?php echo site_url(); ?>/simpanan/autofill",
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url() ?>index.php/simpanan">Simpanan</a></li>
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url(); ?>index.php/simpanan/proses_tambah_data" method="post">
                            <div class="form-group">
                                <label>Nomor Anggota</label>
                                <input type="text" class="form-control" id="noanggota" name="noanggota" value="" onchange="return autofill();">
                            </div>
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input type="date" class="form-control" name="tgl" id="tgl" value="" placeholder="Masukkan Tanggal">
                            </div>
                            <div class="form-group">
                        ...
                        <a class="btn btn-info" href="<?php echo base_url(); ?>index.php/simpanan" role="button">Tutup</a><br><br>
                    </div>
                    </form>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn btn-info btn-sm" href="javascript:cetakData('<?php echo $db['id_simpanan'] ?>')">
                                            ...
                                            <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/simpanan/hapus_data/<?php echo $db['id_simpanan']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
...
<script>
    function autofill() {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/simpanan/cari",
            data: '&noanggota=' + noanggota,
            success: function(data) {
